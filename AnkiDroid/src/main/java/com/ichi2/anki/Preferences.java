    ...
    private void initSubscreen(String action, PreferenceContext listener) {
        ...
        switch (action) {
            case "com.ichi2.anki.prefs.general":
                ...
                /** Themis-#6145 */
                Log.i("Themis", "Event 1: Click \"AnkiDroid\" in Preferences.");
            ...
            case "com.ichi2.anki.prefs.advanced":
                ...
                /** Themis-#6145 */
                Log.i("Themis", "Event 3: Click \"Advanced\" in Preferences.");
                ...
                schedVer.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                    ...
                    public boolean onPreferenceChange(Preference preference, Object newValue) {
                        ...
                        if (newValue.equals(true)) {
                            Log.i("Themis", "Event 4: Enable the \"Experimental V2 Scheduler\".");
                        } else {
